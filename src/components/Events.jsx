        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
          ...
          <div className="glass-panel ticket-shape h-40 flex overflow-hidden hover:bg-white/5 transition-all cursor-pointer">
            <div className="w-24 bg-on-tertiary-container/20 flex flex-col items-center justify-center border-r border-dashed border-white/20 shrink-0">
              <span className="font-headline-lg text-4xl text-white">{e0.date}</span>
              <span className="font-label-bold text-xs uppercase text-white/60">{e0.month}</span>
            </div>
            <div className="flex-1 p-4 flex flex-col justify-between min-w-0">
              <div>
                <h4 className="font-label-bold text-sm text-white uppercase">{e0.title}</h4>
                <p className="font-caption text-[10px] text-on-surface-variant uppercase mt-1">{e0.location}</p>
              </div>
              <span className="material-symbols-outlined text-on-tertiary-container text-lg">military_tech</span>
            </div>
          ...
          <div className="glass-panel ticket-shape h-40 flex overflow-hidden hover:bg-white/5 transition-all cursor-pointer">
            <div className="flex-1 p-0 relative min-w-0">
              ...
              <div className="relative p-4 h-full flex flex-col justify-between">
                <div>
                  <h4 className="font-label-bold text-sm text-white uppercase">{e1.title}</h4>
                  <p className="font-caption text-[10px] text-white uppercase">
                    {e1.month2} | {e1.location}
                  </p>
                </div>
          ...
          <div className="glass-panel ticket-shape h-40 flex overflow-hidden hover:bg-white/5 transition-all cursor-pointer">
            <div className="flex-1 p-4 flex flex-col justify-between min-w-0">
              <div>
                <h4 className="font-label-bold text-sm text-white uppercase">{e2.title}</h4>
                <p className="font-caption text-[10px] text-on-surface-variant uppercase mt-1">{e2.location}</p>
              </div>
          ...
          <div className="glass-panel ticket-shape h-40 flex overflow-hidden hover:bg-white/5 transition-all cursor-pointer">
            <div className="flex-1 p-4 flex flex-col justify-between min-w-0">
              <div>
                <h4 className="font-label-bold text-sm text-white uppercase">{e3.title}</h4>
                <p className="font-caption text-[10px] text-on-surface-variant uppercase mt-1">{e3.location}</p>
              </div>
